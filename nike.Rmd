...
Row {data-heights=210}
-------------------------------------

```{r, echo = F}
print("this analysis including two parts. the first parts data is from the second sheet of the excel.it tells a story about how is the annually differences regarding to  `Gender` and `Division`")

print("and illustrates the overall sale performance regarding to stores and sku by using bubble charts, which could be related to future sales strategies. correlation plot is designed to tell the correlations between those key factors, it could tell more with more characteristics.")
...
```
Row {data-heights=125}
-------------------------------------

```{r, echo = F}
print("below used data from first sheet in Q1, look detailly on specific time span comparison
...
Row {.tabset .tabset-fade data-heights=625 .colored }
-----------------------------------------------------------------------
...
Row {data-heights=1000 .no-padding .colored}
-------------------------------------
